...
--
-- Table structure for table `arquivos_commits2`
--

DROP TABLE IF EXISTS `arquivos_commits2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `arquivos_commits2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projeto_id` int(11) DEFAULT NULL,
  `usuario_id` int(11) DEFAULT NULL,
  `number_pr` varchar(15) DEFAULT NULL,
  `sha_principal` varchar(45) DEFAULT NULL,
  `id_pr` varchar(45) DEFAULT NULL,
  ...
  KEY `idx_arquivos_commits2_projeto_id` (`projeto_id`),
  KEY `idx_arquivos_commits2_usuario_id` (`usuario_id`),
  KEY `idx_arquivos_commits2_arquivo` (`arquivo`)
) ENGINE=MyISAM AUTO_INCREMENT=516527 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2019-10-08 10:43:00
