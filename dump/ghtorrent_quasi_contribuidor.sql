...
--
-- Table structure for table `quasi_contribuidor`
--

DROP TABLE IF EXISTS `quasi_contribuidor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `quasi_contribuidor` (
  ...
  KEY `idx_quasi_contribuidor_user` (`user`),
  KEY `idx_quasi_contribuidor_nome_projeto` (`nome_projeto`),
  KEY `idx_quasi_contribuidor_owner` (`owner`),
  KEY `idx_quasi_contribuidor_number_pr` (`number_pr`)
...
-- Dump completed on 2019-10-08 10:42:57
