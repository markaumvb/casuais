...
--
-- Table structure for table `arquivos_commits3`
--

DROP TABLE IF EXISTS `arquivos_commits3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `arquivos_commits3` (
  ...
  KEY `idx_arquivos_commits3_number_pr` (`number_pr`),
  KEY `idx_arquivos_commits3_id_pr` (`id_pr`)
) ENGINE=MyISAM AUTO_INCREMENT=352525 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2019-10-08 10:41:57
